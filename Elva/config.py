# Modified from https://github.com/open-compass/VLMEvalKit/blob/48d7021503c95ce0847faf4e89ec4714efd34f53/vlmeval/config.py
...
model_groups = [
    ...
    kosmos_series, points_series, nvlm_series, vintern_series, h2ovl_series, elva_series
]
