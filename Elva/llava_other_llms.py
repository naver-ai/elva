...
class LlavaOpenELMConfig(OpenELMConfig):
...
class LlavaOpenELMModel(LlavaMetaModel, OpenELMModel):
    config_class = LlavaOpenELMConfig

    def embed_tokens(self, x):
        return self.token_embeddings(x)


class LlavaOpenELMForCausalLM(OpenELMForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaOpenELMConfig

    def __init__(self, config):
        super(OpenELMForCausalLM, self).__init__(config) 
        self.transformer = LlavaOpenELMModel(config)
...
AutoConfig.register("llava_openelm", LlavaOpenELMConfig)
AutoConfig.register("llava_phi3", LlavaPhi3Config)
AutoModelForCausalLM.register(LlavaOpenELMConfig, LlavaOpenELMForCausalLM)
